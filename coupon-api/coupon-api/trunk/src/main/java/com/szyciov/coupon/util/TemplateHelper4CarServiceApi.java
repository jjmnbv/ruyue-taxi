...
import com.szyciov.coupon.config.WebApiConfig;
...
public class TemplateHelper4CarServiceApi {
	...
	public <T> T dealRequestWithToken(String url, HttpMethod method, String userToken, Object entity,
		...
		ResponseEntity<T> responseEntity = template.exchange(WebApiConfig.getCarserviceApi() + url, method,
				requestEntity,
				responseType);
		return responseEntity.getBody();
	}
