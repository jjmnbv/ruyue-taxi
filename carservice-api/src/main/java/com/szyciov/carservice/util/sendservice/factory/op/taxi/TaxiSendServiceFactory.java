 ...
 *
 */
public class TaxiSendServiceFactory extends SendServiceFactory{
	...
	public SendRuleFactory createSendRuleFactory(){
		...
		return (SendRuleFactory) wac.getBean("TaxiSendRuleFactory");
	}
	...
	public SendMethodFactory createSendMethodFactory(){
		WebApplicationContext wac = ContextLoader.getCurrentWebApplicationContext();  
		return (SendMethodFactory) wac.getBean("TaxiSendMethodFactory");
	}
