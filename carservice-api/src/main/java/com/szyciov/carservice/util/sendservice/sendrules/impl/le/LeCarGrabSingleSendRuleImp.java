...
import static com.szyciov.carservice.util.sendservice.sendrules.SendRuleHelper.SEND_TYPE_GRABSINGLE;
 ...
 *
 */
public class LeCarGrabSingleSendRuleImp extends AbstractSendRule {

	/**
	 * 派单方式
	 */
	private String sendtype = SEND_TYPE_GRABSINGLE;
