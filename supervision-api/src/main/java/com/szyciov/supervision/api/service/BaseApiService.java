...
public class BaseApiService {
     ...
     * @throws IOException
     */
    public HttpContent sendApi(BaseApi baseApi) throws IOException{
        List<BaseApi> list =new ArrayList<>();
        list.add(baseApi);
        return  sendApi(list);
    }
     ...
     * @throws IOException
     */
    public HttpContent sendApi(List<? extends BaseApi> list) throws IOException {
        ...
        HttpContent httpContent = gzwycApiUtil.send(req);
        ...
        if (httpContent.getStatus() == 200) {
            ...
            //保存错误数据
            httpContent.setInfoList(infoList2);
