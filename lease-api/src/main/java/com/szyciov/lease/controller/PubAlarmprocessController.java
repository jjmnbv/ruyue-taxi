...
import com.szyciov.lease.service.PubAlarmprocessService;
...
//		  SavePubAlarmprocessDto saveDto = new SavePubAlarmprocessDto();
...
//	                jsonObject.put("data", infoDto);
	            ...
	            logger.error("新增报警记录异常："+ GsonUtil.toJson(saveDto),e);
	        }
