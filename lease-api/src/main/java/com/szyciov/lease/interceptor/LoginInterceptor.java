package com.szyciov.lease.interceptor;
...
//	}
	...
	public boolean preHandle(HttpServletRequest request, HttpServletResponse response, Object handler)
			throws Exception {
		String userToken = request.getHeader(Constants.REQUEST_USER_TOKEN);
//		System.out.println("api userToken:" + userToken);
		logger.info("api userToken:" + userToken);
