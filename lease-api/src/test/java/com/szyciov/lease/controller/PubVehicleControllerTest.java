...
public class PubVehicleControllerTest {
	...
	public void deleteTest() throws Exception {/*
		PubVehicleQueryParam p = new PubVehicleQueryParam();
		p.setiDisplayStart(0);
		p.setiDisplayLength(10);
		mockMvc.perform(MockMvcRequestBuilders.post("/api/PubVehicle/GetPubVehicleByQuery/"+p))
				.andDo(print())
