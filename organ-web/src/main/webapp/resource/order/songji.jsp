...
<div class="con_body">
	<div class="content_box">
		<div class="left_logo_songji"></div>
		<div class="top"></div>
		<div class="middle">
			<!--1-->
...
<!-- 						<span>添加为常用联系人</span> -->
			...
			<div class="box_2 block">
				<em class="ditu_1"></em>
				<em style="display: none;" class="ditu_2"></em>
		        ...
		        <div class="select_box mar wei2 select_box_1" style="top: 11px;padding-left: 0;">
		            <input  class="select_val" data-value="" value="" id="onAddress" name="onaddress" placeholder="请选择或输入" style="height: 100%;display: block;position: inherit;top: 0;text-indent: 10px;">
		        ...
		        <div class="select_box mar wei2 select_box_1">
		        	<select id="offAddress"  style="height: 40px; width: 100%">
						<option>请选择</option>
					</select>
		        </div>
				<div class="seq_box">
