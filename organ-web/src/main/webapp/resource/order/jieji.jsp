...
<head>
  ...
  .pop_y{    position: absolute;height: 1120px;width: 653px;bottom: 0px;left: 6px;background: rgba(255,255,255,0.6);z-index: 200;}
  </style>
</head>
<body >
...
<input type="hidden" value="2" id="ordertype" name="ordertype"/>
 <%@include file="../head.jsp"%>
<!--内容区域开始-->
<form id="form">
<div class="con_body">
	<div class="content_box">
		<div class="left_logo_jieji"></div>
		<div class="top"></div>
		<div class="middle">
			<!--1-->
...
<!-- 						<span>添加为常用联系人</span> -->
			...
			<!--3-->
			<div class="box_2 block">
				<em style="display: none;" class="ditu_1"></em>
				<em class="ditu_2 ditu_jieji"></em>
		        ...
		        <div class="title_1">
					<span class="title_active">*</span>
					<span class="title_info">航班号</span>
				</div>
				<div class="input_box mar">
		            <input  class="inp" id="fltno" data-value="" placeholder="航班号：如SDF234" maxlength="6">
		        </div>
		        <div class="title_1">
					<span class="title_active">*</span>
					<span class="title_info">落地时间</span>
				</div>
				<div class="select_box mar select_box_1">
                     <div class="ztimepicker">
						<input type="text" style="height: 40px; line-height: 40px;"  readonly value="" class="ztimepicker_input" name="falltime" id="fallTime"/>
						<div class="ztimebox"   style="left: -11px; top: 40px;">
							<div class="znow">落地时间</div>
							<div class="ztimebox_s">
								<ul class="zday">
								</ul>
								<ul class="zhour">
		        ...
		        <div class="title_1">
					<span class="title_active">*</span>
					<span class="title_info">机场地址</span>
				</div>
				<div class="select_box mar wei1 select_box_1 myaddclass" style="top: -24px;">
					<input type="hidden" id="onCity" name="oncity" style="width:100%;"/>
		        </div>
		        <div class="select_box mar wei2 select_box_1">
					<select name="onaddress" id="onAddress" style="height: 40px; width: 100%">
				...
				<div class="select_box mar wei1 select_box_1  myaddclass" >
					<input type="hidden" id="offCity" name="offcity" style="width:100%;"/>
		        </div>
		        <div class="select_box mar wei2 select_box_1" style="top: 11px;padding-left: 0;">
		            <input  class="select_val" data-value="" value="" id="offAddress" name="offaddress" placeholder="请选择或输入" style="height: 100%;display: block;position: inherit;top: 0;text-indent: 10px;">
