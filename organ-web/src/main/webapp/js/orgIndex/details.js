 var points = [];
    ...
    $(document).ready(function() {
        ...
        $(".trail").click(function(){
           ...
           $.get("OrgIndex/GetOrgOrderByOrderno",data,function(result){
...
//			startDate: "2016-09-21 10:00:00",
//			endDate: "2016-09-21 21:00:00"
//		};
//		$.get("OrgIndex/GetOrgOrderTraceData", data, function (result) {
	...
	function bindMap(traceData, order) {
	 ...
	 function bindGps(traceData, order) {
	    ...
	    if(gpsList != null && gpsList.length > 0) {
	     	...
	     	var content = "<p><font style='font-weight:bold;'>&nbsp服务开始时间：" + changeToDate(order.starttime) +
	 		...
	 		map.addOverlay(marker);
	 		content = "<p><font  style='font-weight:bold;'>服务结束时间：" + changeToDate(order.endtime) +
...
//	 	map.addOverlay(car);
	 ...
	 /**
		...
		function callBack(obj,billsId){
			if(obj == "bill"){
				location.href = base+"FinancialManagement/BillDetail/"+billsId;
			}else{
				location.href = base+"OrgIndex/Index";
			}
        };