...
import com.xxkj.passenger.wechat.util.BasicRequest;
import com.xxkj.passenger.wechat.util.EntityInfoList;
...
public class LogAspect {
    ...
    @Pointcut("execution(* com.xxkj.passenger.wechat.*.service..*(..))")
    public void aspect(){
