...
public class User {
	...
	private String headportraintmax;
	...
	public String getHeadportraintmax() {
		return headportraintmax;
	}

	public void setHeadportraintmax(String headportraintmax) {
		this.headportraintmax = headportraintmax;
	}
