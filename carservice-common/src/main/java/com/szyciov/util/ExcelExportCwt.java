...
public class ExcelExportCwt {
	...
	public ExcelExportCwt(Excel excel) {
		this.excel = excel;

	}

	public ExcelExportCwt(HttpServletRequest request, HttpServletResponse response){
		this.request = request;
		this.response = response;
	}

	public ExcelExportCwt(HttpServletRequest request, HttpServletResponse response, Excel excel){
		this.request = request;
		this.response = response;
		this.excel = excel;
	}
...
//		sheet.autoSizeColumn(colNum);//自动调整宽度
	...
	public static void main(String[] args) {
		...
		ExcelExportCwt ee = new ExcelExportCwt(excel);
		ee.setSheetMaxRow(6);
