...
public class BankUtil {
	public static void main(String[] args) {
		String cardNumber = "6214467873110269336";//卡号
		String name = getBankInfo(cardNumber);
		System.out.println(name);
		String name1 = getBankName(cardNumber);
	 ...
	 * @return
	 */
	public static String getBankName(String idCard){
		String bankinfo = getBankInfo(idCard);
	 ...
	 * @return
	 */
	public static String getBankInfo(String idCard) {
		int index = -1;
