...
public class Const {
	 ...
	 * 密码登录
	 */
	public static final String PWDLOGIN = "0";
	
	/**
	 * 验证码登录
	 */
	public static final String CODELOGIN = "1";
	...
	public static final String SMSTYPE_CHANGEPWD = "2";
	public static final String SMSTYPE_REGISTER = "0";
