...
$(function () {
    ...
    $("#btnCancel").click(function () {
        location.href = basePath + "AlarmTimeLimit/Index";
    })
});
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (trackStatus == '1') {
                ...
                //画时间栅栏的线
                if(data.trajectory.alarmList.timelimitList == null || data.trajectory.alarmList.timelimitList.length ==0){
                    toastr.warning("当前行程没有栅栏信息", "提示信息");
                    return;
                }
                var TimeLimitGpsList =  data.trajectory.alarmList.timelimitList;
