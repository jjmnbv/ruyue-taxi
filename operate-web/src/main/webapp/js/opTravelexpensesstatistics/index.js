...
function initGrid() {
	var gridObj = {
		...
		iLeftColumn: 1,
		scrollX: true,
		sAjaxSource: "OpTravelexpensesstatistics/GetDate?timeType="+$("#timeType").val()+"&startTime1="+$("#startTime1").val()+"&endTime1="+$("#endTime1").val(),
        columns: [
        	{mDataProp: "id", sTitle: "Id", sClass: "center", visible: false},
 	        ...
 	        {mDataProp: "runMoney", sTitle: "金额(元)", sClass: "center", sortable: true }
...
function initGrid1() {
	var gridObj = {
		...
		iLeftColumn: 1,
		scrollX: true,
		sAjaxSource: "OpTravelexpensesstatistics/GetDateDriver?timeType="+$("#timeType1").val()+"&startTime1="+$("#startTime2").val()+"&endTime1="+$("#endTime2").val(),
        columns: [
        	{mDataProp: "id", sTitle: "Id", sClass: "center", visible: false},
 	        {mDataProp: "time", sTitle: "时间", sClass: "center", visible: true },
...
function initSelectDriver() {
	...
	$("#driver").select2({
		...
		allowClear : true,
		ajax : {
			url : "OpTravelexpensesstatistics/GetDriver?",
			dataType : 'json',
