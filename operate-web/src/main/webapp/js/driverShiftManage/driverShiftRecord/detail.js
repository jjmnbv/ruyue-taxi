        ...
        columns: [
			...
			{mDataProp: "onlinetimeStr", sTitle: "在线时长", sClass: "center", sortable: true },
			{
				...
				"mRender": function (data, type, full) {
					switch(data) {
						case "交接班": return "交接班"; break;
						case "车辆回收": return "车辆回收"; break;
						case "指定当班": return "指定当班"; break;
						default: return "/";
					}
				}
			},
			...
			{mDataProp: "relievedtype", sTitle: "交班类型", sClass: "center", sortable: true,mRender:function (data, type, full) {
				switch(data) {
					case "自主交班": return "自主交班"; break;
					case "人工指派": return "人工指派"; break;
					default: return "/";
				}
			} },
