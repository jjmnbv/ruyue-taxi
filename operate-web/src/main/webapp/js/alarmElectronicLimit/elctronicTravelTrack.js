...
$(function () {
    ...
    $("#btnCancel").click(function () {
        location.href = basePath + "AlarmElectronicLimit/Index";
    })
});
    ...
    $.ajax({
        ...
        success: function (data) {
            ...
            if (trackStatus == '1') {
                ...
                //画时间栅栏的线
                if(data.trajectory.alarmList.electroniclimitList == null || data.trajectory.alarmList.electroniclimitList.length ==0){
                    toastr.warning("当前行程没有栅栏信息", "提示信息");
                    return;
                }
                var TimeLimitGpsList =  data.trajectory.alarmList.electroniclimitList;
