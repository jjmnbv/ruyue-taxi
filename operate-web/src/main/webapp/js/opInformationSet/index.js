...
function allocation(allocation){
	$.post("OpInformationSet/GetOpPlatformInfo",function (status) {
		if (allocation == "alipay" && null != status && null != status.alipaystatus && status.alipaystatus != '') {
			var comfirmData={
				tittle:"提示",
		...
		} else if(allocation == "wechat" && null != status && null != status.wechatstatus && status.wechatstatus != '') {
			var comfirmData={
				tittle:"提示",
...
function toAllocation(allocation) {
	window.location.href = base+"OpInformationSet/AllocationIndex/"+allocation;
}

//支付宝开通账户
function openAlipay(){
	$.post("OpInformationSet/GetOpPlatformInfo",function (status) {
		if (null != status && null != status.alipaystatus && status.alipaystatus != '') {
			var comfirmData={
				tittle:"提示",
				context:"确定开通支付宝收款功能？",
				button_l:"确定",
...
function closeAlipay(){
	$.post("OpInformationSet/GetOpPlatformInfo", function (status) {
		if (null != status && null != status.wechatstatus && status.wechatstatus != '') {
