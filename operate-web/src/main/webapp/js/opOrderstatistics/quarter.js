...
function initGrid() {
	var gridObj = {
		...
		iLeftColumn: 1,
		scrollX: true,
        sAjaxSource: "OpOrderstatistics/monthData?starttime="+$("#startTime").val()+"&endtime="+$("#jidu").val()+"&type=1",
        columns: [
	        {mDataProp: "id", sTitle: "Id", sClass: "center", visible: false},
	        {mDataProp: "starttime", sTitle: "季度", sClass: "center", visible: true },
...
function exportExcel(){
	window.location.href=$("#baseUrl").val()+"OpOrderstatistics/exportExcel?starttime="+$("#startTime").val()+"&leasescompanyid="+$("#custom").val()+"&endtime="+$("#jidu").val()+"&type=1";
}