...
function initGrid() {
	var gridObj = {
		...
		iLeftColumn: 1,
		scrollX: true,
        sAjaxSource: "OpOrderstatistics/monthData?starttime="+$("#startTime").val()+"&type=0",
        columns: [
	        {mDataProp: "id", sTitle: "Id", sClass: "center", visible: false},
	        {mDataProp: "starttime", sTitle: "月份", sClass: "center", visible: true },
	        ...
	        {mDataProp: "pickuporders", sTitle: "接机订单", sClass: "center", sortable: true },
...
function exportExcel(){
	window.location.href=$("#baseUrl").val()+"OpOrderstatistics/exportExcel?starttime="+$("#startTime").val()+"&leasescompanyid="+$("#custom").val()+"&type=0"+"&endtime=null";
}