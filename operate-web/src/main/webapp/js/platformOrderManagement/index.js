...
function initGrid() {
	var gridObj = {
		id: "dataGrid",
        sAjaxSource: "PlatformOrderManagement/GetNetAboutCarOrderByQuery",
        iLeftColumn: 3,
        scrollX: true,
        language: {
        	sEmptyTable: "暂无订单信息"
        ...
        columns: [
        	...
        	{mDataProp: "cancelamount", sTitle: "处罚金额", sClass: "center", sortable: true },
	        ...
	        {mDataProp: "ordernature", sTitle: "订单性质", sClass: "center", sortable: true },
...
function initSelect2() {
	$("#orderPerson").select2({
		...
		allowClear : true,
		ajax : {
			url : "PlatformOrderManagement/GetNetAboutCarOrderUserByQuery",
			dataType : 'json',
	...
	$("#driver").select2({
		...
		allowClear : true,
		ajax : {
			url : "PlatformOrderManagement/GetNetAboutCarOrderDriverByQuery?vehicleType=0",
			dataType : 'json',
			data : function(term, page) {
				return {
					driver: term
    ...
    $("#leasescompanyid").select2({
        ...
        allowClear: true,
        ajax: {
            url: "PlatformOrderManagement/GetPartnerCompanySelect?servicetype=0",
            dataType: 'json',
            data: function (term, page) {
                $(".datetimepicker").hide();
                return {
...
function exportExcel() {
	window.location.href= document.getElementsByTagName("base")[0].getAttribute("href") + "PlatformOrderManagement/GetNetAboutCarOrderExport?orderNo="+$("#orderNoExport").val()
