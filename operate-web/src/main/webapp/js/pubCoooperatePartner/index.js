...
function initLeasecompany() {
    $("#leasecompany").select2({
        ...
        allowClear: true,
        ajax: {
            url: "PubCoooperatePartner/queryLeasecompany",
            dataType: 'json',
...
function initGrid() {
    var grid = {
        id: "dataGrid",
        sAjaxSource: "PubCoooperatePartner/queryPubCoooperateData",
        userQueryParam: [
...
function disableCoooperate(id){
    ...
    $.ajax({
        type: 'POST',
        url: "PubCoooperatePartner/disableCoooperate",
...
function agreement(id){
    window.location.href = "PubCoooperatePartner/cooagreementView/" + id;
}
...
function reviewPopConfirm(){
    ...
    $.ajax({
        type: 'POST',
        url: "PubCoooperatePartner/reviewLeasecompany",
        data: JSON.stringify(data),
        dataType: "json",
