...
function reviewRecordDataGridInit() {
	var gridObj = {
        ...
        columns: [
	        ...
	        {mDataProp: "reason", sTitle: "复核原因", sClass: "center", sortable: true,
	        	"mRender": function(data, type, full) {
...
function reviewPost() {
	...
	$.ajax({
		type: "POST",
		dataType: "json",
		url: $("#baseUrl").val() + "OrderManage/OpOrderReview",
		...
		success: function (result) {
			...
			if (result.status == "success") {
				...
				toastr.options.onHidden = function() {
            		window.location.href = $("#baseUrl").val() + "OrderManage/WasAbnormalOrderIndex";
            	}
