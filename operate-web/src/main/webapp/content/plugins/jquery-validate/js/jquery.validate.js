	...
	defaults: {
		...
		highlight: function( element, errorClass, validClass ) {
			if ( element.type === "radio" ) {
				...
				$(element).prev(".ico_user,.ico_lock").css("background-color","#f33333");
				//console.log($(element));
				//$(element).find(".ico_user,.ico_lock").css("background-color","#f33333");
			}
		},
		unhighlight: function( element, errorClass, validClass ) {
			if ( element.type === "radio" ) {
				...
				$(element).prev(".ico_user,.ico_lock").css("background-color","#dbdbdb");
			}
		}
	},
