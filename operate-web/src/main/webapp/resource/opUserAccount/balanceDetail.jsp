...
<html lang="zh-CN">
	...
	<body>
		<div class="crumbs">
		    <a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > <a class="breadcrumb" href="OpUserAccount/Index">用户账户</a> > 余额明细
		...
		<div class="content">
			...
			<div class="row">
			   <div class="col-10" style="margin-top: 15px;width:60%;"><h4>余额明细【<font color="red">${account} ${nickName}</font>】</h4></div>
		...
		<script type="text/javascript" src="js/opUserAccount/balanceDetail.js"></script>
	</body>
</html>
