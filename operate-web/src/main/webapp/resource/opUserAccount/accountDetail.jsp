...
<html lang="zh-CN">
	...
	<body  class="opuseraccount_css_body">
		<div class="crumbs"><a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > <a class="breadcrumb" href="OpUserAccount/Index">用户账户</a> > 交易明细
		...
		<div class="content">
			...
			<div class="row">
			   <label class="col-4" style="margin-top: 15px;"><h4>交易明细【<font color="red">${account} ${nickName}</font>】</h4></label>
		...
		<script type="text/javascript" src="js/opUserAccount/accountDetail.js"></script>
	</body>
</html>
