...
<html lang="zh-CN">
	...
	<body>
		...
		<div class="crumbs">
			<a href="javascript:void(0);" onclick="homeHref()" class="breadcrumb">首页</a> > 平台驻点信息
		...
		<div class="content">
			<div class="row form" style="padding-top: 30px;">
				<div class="col-3">
					<label class="col-1">机构所在地</label><input class="col-3" id="city" name="city" type="text" placeholder="全部">
				</div>
				<div class="col-3">
					<label>负责人姓名</label>
					<input id="responsible" name="responsible" type="text" placeholder="">
				</div>
				<div class="col-3">
					<label>负责人电话</label>
					<input id="responsibleway" name="responsibleway" type="text" placeholder="">
				</div>
			</div>
			<div class="row form">
		...
		<div class="pop_box" id="importExcelDiv" style="display: none;">
			<div class="tip_box_b">
				<h3 id="importExcel">导入平台驻点信息</h3>
				<img src="content/img/btn_guanbi.png" class="close" alt="关闭">
				<div class="row">
					<div class="col-12">
						提示：请确保文件的格式与导入excel模板的格式一致
					</div>
				</div>
				<div class="row">
					<div class="col-12">
		...
		<script type="text/javascript" src="js/opPlatformStagnation/index.js"></script>
	</body>
</html>
