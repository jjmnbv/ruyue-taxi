        ...
        <div class="row ">
            ...
            <div class="col-4">
                <div class="form-group">
                    ...
                    <div class="col-8">
                        <input type="text" class="form-control  datetimepicker" name="txtFromTime" id="txtFromTime"
                               readonly="readonly"/>
                    </div>
                </div>
            </div>
            <div class="col-4">
                <div class="form-group">
                    ...
                    <div class="col-8">
                        <input type="text" class="form-control  datetimepicker" name="txtToTime" id="txtToTime"
                               readonly="readonly"/>
                    </div>
                </div>
            </div>
        ...
        <div class="row ">
            ...
            <div class="col-8">
                <div class="pull-right">
                    <button type="button" class="btn btn-default blue " id="btnSearch" onclick="onSelect()"><img
...
<script type="text/javascript" src="js/alarmWaterTemp/index.js"></script>
