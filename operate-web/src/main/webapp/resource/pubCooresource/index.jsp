...
<div class="crumbs"><a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > 联营资源
</div>
<div class="content">
    <div class="form" style="padding-top: 30px;">
        <div class="row">
            ...
            <div class="col-3" style="text-align: right;">
                ...
                <button id="clearSearchBox" class="Mbtn grey_w">清空</button>
            </div>
        </div>
    </div>
    <br/>
            ...
            <form method="get" class="form-horizontal  m-t" id="frmmodal">
                <div class="row">
                    ...
                    <div class="col-12" style="text-align:left;">
                        ...
                        <input style="width:100px;margin-left: -3px" id="validateTimeStart" type="text" placeholder="开始日期" class="searchDate" readonly="readonly">
                ...
                <div class="row">
                    ...
                    <div class="col-12" style="text-align:left;">
                        <textarea rows="3" id="reviewResion" style="width: 70%;margin: 0px 50px;" placeholder="请输入拒绝原因" maxlength="200"></textarea>
                    </div>
...
<script type="text/javascript" src="js/pubCooresource/index.js"></script>
