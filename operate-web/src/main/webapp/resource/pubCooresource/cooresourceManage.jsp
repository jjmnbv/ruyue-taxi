...
<div class="crumbs">
    <a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > <a class="breadcrumb" href="javascript:void(0);" onclick="back()">联营资源</a> > 资源管理
...
<div class="pop_box" id="vehicleModelPop" style="display: none;">
    <div class="tip_box_b">
            ...
            <form method="get" class="form-horizontal  m-t" id="frmmodal">
                <div class="row">
                    ...
                    <div class="col-12" style="text-align:left;">
                        ...
                        <div class="col-8">
                            <select id="vehicleModelIdPop">
                                <option value="">请选择</option>
                            </select>
                        </div>
                    </div>
                    <div class="col-12" style="text-align:left;">
                        <div class="col-9" style="color: #999;">注:车型修改不影响车辆归属方服务车型数据</div>
                    </div>
                </div>
            </form>
            <button id="reviewPopConfirmBtn" class="Lbtn red" onclick="updateVehicleModel()">确定</button>
            <button class="Lbtn grey" style="margin-left: 10%;" onclick="closeVehicleModelPop()">取消</button>
        </div>
    </div>
</div>
<script type="text/javascript" src="js/pubCooresource/cooresourceManage.js"></script>
