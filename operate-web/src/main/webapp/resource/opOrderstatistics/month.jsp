...
<html lang="zh-CN">
	...
	.content{padding-top:20px;height:940px;}
	 ...
	 <input name="baseUrl" id="baseUrl" value="<%=basePath%>" type="hidden">
	     <div class="row">
                <div class="col-3">
	                <div class="radius row opOrderstatistics_css_row_1" style="background-color:#00CACA;margin-left:0px;">
                  ...
                  <div class="col-3">
	                <div class="radius row opOrderstatistics_css_row_1" style="background-color:#00CACA;margin-left:20px;">
		                <div class="order_tittle col-6" style="height:100px;">
		                	<span style="vertical-align:text-bottom;font-size:15px;">截止日前</span>
		                </div>
		                <div class="order_num1 col-6" id="totalcount"></div>
	    ...
	    <div class="col-12">
			<ul class="tabmenu">
				<li class="ok">按月度统计</li>
				<li><a href="OpOrderstatistics/quarter">按季度统计</a></li>
				<li><a href="OpOrderstatistics/year">按年度统计</a></li>
			</ul>
	 ...
	 <script type="text/javascript" src="js/opOrderstatistics/month.js"></script>
	 <script>
