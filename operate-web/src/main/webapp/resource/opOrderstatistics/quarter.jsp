...
<html lang="zh-CN">
	...
	.tabmenu a{text-decoration:none;}
	 ...
	 <input name="baseUrl" id="baseUrl" value="<%=basePath%>" type="hidden">
	    ...
	    <div class="col-12">
			<ul class="tabmenu">
				<li><a href="OpOrderstatistics/month">按月度统计</a></li>
				<li class="ok">按季度统计</a></li>
	 ...
	 <div class="row form">
	    ...
	    <div class="col-4" style="padding-top: 0px;">
	     <label>选择季度</label>
	     <select id="jidu" name="jidu"style="padding-top: 4px;padding-bottom: 4px;">
	 ...
	 <script type="text/javascript" src="js/opOrderstatistics/quarter.js"></script>
	  <script>
