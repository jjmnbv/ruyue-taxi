...
<html lang="zh-CN">
	...
	<body>
		...
		<div class="crumbs"><a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > 平台监管订单管理</div>
		<div class="content">
			<ul class="tabmenu" style="padding-top: 20px;">
				<li class="on">网约车订单</li>
<!-- 			    <li><a href="OrderManage/TaxiIndex" style="text-decoration: none;">出租车订单</a></li> -->
			</ul>
			
			<input name="orderNoExport" id="orderNoExport" type="hidden">
			<input name="orderTypeExport" id="orderTypeExport" type="hidden">
			...
			<div class="row form" style="margin-top:20px;">
				<div class="col-3">
					...
					<select id="orderSource" style="margin-left: -3px;">
						...
						<option value="20">机构端</option>
						<option value="10">乘客端|因公</option>
						<option value="11">乘客端|因私</option>
						<option value="100">租赁端|因公</option>
						<option value="101">租赁端|因私</option>
					</select>
				</div>
				<div class="col-3">
				  <label>订单归属</label><input id="leasescompanyid" type="hidden" placeholder="服务车企">
                </div>
				<div class="col-3">
					<label>订单类型</label>
			...
			<div class="row form">
				...
				<div class="col-3">
					<label>支付渠道</label>
					<select id="payType" style="margin-left: -3px;">
						<option value="">全部</option>
				...
				<div class="col-3">
					<label>取消方</label>
					<select id="cancelParty" style="margin-left: -3px;">
						<option value="">全部</option>
		...
		<script type="text/javascript" src="js/platformOrderManagement/index.js"></script>
	</body>
</html>
