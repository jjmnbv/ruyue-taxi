...
<body>
	<div class="crumbs">
		<a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > <a class="breadcrumb" href="OpInformationSet/driver/Index">司机收款账户管理</a> > 微信收款账户
	</div>
	<div class="content">
		...
		<form id="editWechatForm" class="form" method="post">
			...
			<div class="row">
				<div class="col-10">
					...
					<textarea style="width: 720px;height: 40px;" id="driverwechatpayaccount" name="driverwechatpayaccount" maxlength="50">${opPlatformInfo.driverwechatpayaccount}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label>APPID<em class="asterisk"></em></label>
					<textarea style="width: 720px;height: 80px;" id="driverwechatappid" name="driverwechatappid" maxlength="100">${opPlatformInfo.driverwechatappid}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label>商户号<em class="asterisk"></em></label>
					<textarea style="width: 720px;height: 80px;" id="driverwechatmerchantno" name="driverwechatmerchantno"  maxlength="100">${opPlatformInfo.driverwechatmerchantno}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label>商户密钥<em class="asterisk"></em></label>
					<textarea style="width: 720px;height: 80px;" id="driverwechatsecretkey" name="driverwechatsecretkey"  maxlength="3500">${opPlatformInfo.driverwechatsecretkey}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
	...
	<script type="text/javascript" src="js/opInformationSet/driver/wechat.js"></script>
	<script type="text/javascript">
