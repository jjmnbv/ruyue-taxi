	...
	<div class="content">
		...
		<div class="form">
			<div style="height: 30px;width: 100%;">
				...
				<c:choose>
					<c:when test="${opPlatformInfo.driveralipaystatus == '1'}">
			...
			<div class="row">
				<div class="col-10">
					<label>商家支付宝账户</label>
					<p style="height: 80px;">${fn:length(opPlatformInfo.driveralipayaccount) == 0 ? "无" : opPlatformInfo.driveralipayaccount}</p>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label>APPID</label>
					<p style="height: 80px;">${fn:length(opPlatformInfo.driveralipayappid) == 0 ? "无" : opPlatformInfo.driveralipayappid}</p>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label>应用私钥</label>
					<p style="height: 300px;overflow:hidden;">${fn:length(opPlatformInfo.driveralipayprivatekey) == 0 ? "无" : opPlatformInfo.driveralipayprivatekey}</p>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label>支付宝公钥</label>
					<p style="height: 100px;overflow:hidden;">${fn:length(opPlatformInfo.driveralipaypublickey) == 0 ? "无" : opPlatformInfo.driveralipaypublickey}</p>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label>合作伙伴ID</label>
					<p style="height: 80px;">${fn:length(opPlatformInfo.driveralipaypartnerid) == 0 ? "无" : opPlatformInfo.driveralipaypartnerid}</p>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label>合作伙伴私钥</label>
					<p style="height: 300px;overflow:hidden;">${fn:length(opPlatformInfo.driveralipaypartnerprivatekey) == 0 ? "无" : opPlatformInfo.driveralipaypartnerprivatekey}</p>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label>合作伙伴公钥</label>
					<p style="height: 100px;overflow:hidden;">${fn:length(opPlatformInfo.driveralipaypartnerpublickey) == 0 ? "无" : opPlatformInfo.driveralipaypartnerpublickey}</p>
				</div>
			</div>
			<div class="row form" style="padding-top: 30px;">
			</div>
			<div style="height: 30px;width: 100%;">
				...
				<c:choose>
					<c:when test="${opPlatformInfo.driverwechatstatus == '1'}">
			...
			<div class="row">
				<div class="col-10">
					<label>商家微信账户</label>
					<p style="height: 40px;">${fn:length(opPlatformInfo.driverwechatpayaccount) == 0 ? "无" : opPlatformInfo.driverwechatpayaccount}</p>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label>APPID</label>
					<p style="height: 80px;">${fn:length(opPlatformInfo.driverwechatappid) == 0 ? "无" : opPlatformInfo.driverwechatappid}</p>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label>商户号</label>
					<p style="height: 80px;">${fn:length(opPlatformInfo.driverwechatmerchantno) == 0 ? "无" : opPlatformInfo.driverwechatmerchantno}</p>
				</div>
			</div>
			<div class="row">
				<div class="col-10">
					<label>商户密钥</label>
					<p style="height: 80px;overflow:hidden;">${fn:length(opPlatformInfo.driverwechatsecretkey) == 0 ? "无" : opPlatformInfo.driverwechatsecretkey}</p>
				</div>
			</div>
		</div>
	</div>
	<script type="text/javascript" src="js/opInformationSet/driver/index.js"></script>
	<script type="text/javascript">
