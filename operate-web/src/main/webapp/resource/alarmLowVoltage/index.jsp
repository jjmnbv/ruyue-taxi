...
<div class="crumbs">
    <a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > 低电压
</div>
<div class="content">
    <div class="form-horizontal">
        ...
        <div class="row ">
            ...
            <div class="col-4">
                <div class="form-group">
                    <label class="control-label col-4">状态</label>
                    <div class="col-8">
...
<script type="text/javascript" src="js/alarmLowVoltage/index.js"></script>
