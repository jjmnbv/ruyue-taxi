...
<div class="content">
    ...
    <div class="form-horizontal">
        <div class="row ">
            ...
            <div class="col-4">
                <div class="form-group">
                    ...
                    <div class="col-8">
                        <input type="text" class="form-control  datetimepicker" name="txtStarTime"
                               id="txtStarTime" readonly="readonly"/>
                    </div>
                </div>
            </div>
            <div class="col-4">
                <div class="form-group">
                    ...
                    <div class="col-8">
                        <input type="text" class="form-control  datetimepicker" name="txtEndTime"
                               id="txtEndTime" readonly="readonly"/>
                    </div>
                </div>
            </div>
        </div>
        ...
        <div class="row">
            <%--<div class="col-4">
                <div class="form-group">
                    <label class="control-label col-4">驾驶员</label>
                    <div class="col-8">
                        <input type="text" class="form-control" name="txtDriverName" id="txtDriverName"/>
                    </div>
                </div>
            </div>--%>
            <div class="col-12">
...
<script type="text/javascript" src="js/alarmTimeLimit/index.js"></script>
