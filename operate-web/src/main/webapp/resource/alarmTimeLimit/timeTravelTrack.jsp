...
<div class="crumbs">
    ...
    <a href="<%=basePath%>AlarmTimeLimit/Index">时间栅栏</a>>行驶轨迹
...
<div class="content">
    ...
    <input type="hidden" value="${timeViolation.eqpId}" id="eqpId">
    <input type="hidden" value="${timeViolation.trackStatus}" id="trackStatus">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-8">
                                            <p class="form-control-static" id="pV_PROPERTY">
                                                ${timeViolation.lengthOfViolation}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-8">
                                            <p class="form-control-static" id="illegalMileage">
                                                ${timeViolation.illegalMileage}km
                                            </p>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript" src="js/alarmTimeLimit/timeTravelTrack.js??ver=<%=Math.random()%>"></script>
