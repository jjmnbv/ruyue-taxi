		...
		<div class="content">
			<div class="form" style="padding-top: 30px;">
				...
				<div class="row">
					...
					<div class="col-3" style="text-align: right;float: right;margin-right:30px;">
	            	...
	            	<form id="editForm" method="get" class="form-horizontal  m-t" id="frmmodal">
	            		...
	            		<div class="row">
	            			<div class="col-8" style="padding-left:4.4%;">
								<label style="text-align: left;width: 18%;padding-left: 1%;">指定用户<em class="asterisk"></em></label>
		            			<div id="selectuser">
		            				<input type="button" class="adduserbtn" value="+添加用户" style="margin-left: 5px;"/>
	            				...
	            				<label for="addcboxId2" class="error">请选择指定用户</label>        			
	            		<div class="row">
	            			<div class="col-6">
	            				<label>发放张数<em class="asterisk"></em></label>
	            				<input type="text" id="sendcount" name="sendcount" placeholder="每人发放张数" maxlength="2" value="" />
	            			</div>
	            		</div>
						</div>
	            		<div class="row">
	            			<div class="col-6">
	            				<div style="margin-bottom: 5px;"><label>派发金额<em class="asterisk"></em></label><input type="radio" name="sendmoneytype" value="1" checked="checked" />固定  <input id='sendfixedmoney' name='sendfixedmoney' placeholder="必填"  maxlength="3" type="text" style="width:15%;"/> 元</div>
	            				<div><label style="opacity:0;">派发金额<em class="asterisk"></em></label><input type="radio" name="sendmoneytype" value="2"/>随机  
	            				<input id='sendlowmoney' name='sendlowmoney' type="text" maxlength="3" style="width:15%;" placeholder="必填" disabled="disabled"/> - <input id='sendhighmoney' name='sendhighmoney' type="text" maxlength="3" style="width:15%;" placeholder="必填" disabled="disabled" /> 元</div>
	            			</div>
	            		</div>
	            		<div class="row">
	            		...
	            		<div class="row">
	            			<div class="col-8" style="padding-left:4.4%;">
								<label style="text-align: left;width: 18%;padding-left: 1%;">发放区域<em class="asterisk"></em></label>
		            			<div id="pubCityaddr">
	            				...
	            				<input id="businessScope" name="businessScope" type="hidden" value=""/>
	            				<div id ="addcboxId" class="addcbox" name="addcboxId">           			
	            				</div>
	            		...
	            		<div class="row">
	            			<div class="col-6" style="width: 72%">
	            				<div><label style="width:21%;">有效期<em class="asterisk"></em></label>
