...
<html lang="zh-CN">
	...
	<body>
		...
		<div class="crumbs">
			<a href="javascript:void(0);" onclick="homeHref()" class="breadcrumb">首页</a> > 经营许可信息
		...
		<div class="content">
			<div class="row form" style="padding-top: 30px;">
				<div class="col-3">
					<label>经营许可证号</label>
					<input id="certificate" name="certificate" type="text" placeholder="">
				</div>
				<div class="col-3">
					<label class="col-1">经营许可地</label>
					<input class="col-3" id="address" name="address" type="text" placeholder="全部">
				</div>
		...
		<script type="text/javascript" src="js/opPlatformBusinesslicense/index.js"></script>
	</body>
</html>
