        ...
        <div style="padding-top: 30px;">
            <ul class="tabbox">
                <li style="display:block">
                    <div class="stab">
                        <div class="shen_on">待处理投诉</div>
                        <div><a href="PubComplaintManage/processed" style="text-decoration: none;">已处理投诉</a></div>
                    </div>
                    <div class="stabox">
                        <div class="row">
                            <div class="col-3">
    ...
    <div class="pop_box" id="resultPop" style="display: none;">
        <div class="tip_box_b">
            ...
            <div class="row" style="margin-top: 20px">
                ...
                <select style="width: 300px;" id="processresultPop">
                    <option value="0" selected="selected">情况属实</option>
		...
		<script type="text/javascript" src="js/pubComplaintManage/index.js"></script>
	</body>
</html>
