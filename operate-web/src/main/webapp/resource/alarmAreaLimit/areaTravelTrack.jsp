...
<div class="crumbs">
    ...
    <a href="<%=basePath%>AlarmAreaLimit/Index">区域栅栏></a>行驶轨迹
...
<div class="content">
    ...
    <input type="hidden" value="${areaViolation.eqpId}" id="eqpId">
    <input type="hidden" value="${areaViolation.trackStatus}" id="trackStatus">
                    ...
                    <form class="form-horizontal" role="form">
                        ...
                        <div class="form-body">
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-8">
                                            <p class="form-control-static" id="pV_PROPERTY">
                                                ${areaViolation.lengthOfViolation}
                                            </p>
                                        </div>
                                    </div>
                                </div>
                            ...
                            <div class="row">
                                <div class="col-4">
                                    <div class="form-group">
                                        <label class="control-label col-4">越界里程：</label>
                                        <div class="col-8">
                                            <p class="form-control-static" id="illegalMileage">
                                                ${areaViolation.outOfBoundsMileage}km
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-8">
                                            <p class="form-control-static" id="startOfViolation">
                                                ${areaViolation.startOfViolation}km
                                            </p>
                                        </div>
                                    </div>
                                </div>
                                    ...
                                    <div class="form-group">
                                        ...
                                        <div class="col-8">
                                            <p class="form-control-static" id="endOfViolation">
                                                ${areaViolation.endOfViolation}km
                                            </p>
                                        </div>
                                    </div>
                                </div>
...
<script type="text/javascript" src="js/alarmTimeLimit/areaTravelTrack.js??ver=<%=Math.random()%>"></script>
