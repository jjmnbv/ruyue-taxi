	...
	<body>
		...
		<div class="content">  
			<div class="row form" style="padding-top: 30px;">
			    <ul class="tabmenu">
                    <li class="on">司机操作记录</li>
                    <li><a href="PubDriverVehicleRef/VehicleOperateDetail" style="text-decoration: none;">车辆操作记录</a></li>
                </ul>
				
				<div class="col-3">
					<label>司机</label>
					<input id="driver" name="driver" type="text" placeholder="姓名/手机号码">
				</div>
		...
		<script type="text/javascript" src="js/pubDriverVehicleRef/driveroperatedetail.js"></script>
	</body>
</html>
