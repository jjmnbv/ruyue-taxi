...
<html lang="zh-CN">
	...
	<body class="ordermanage_css_body">
		...
		<div class="crumbs"><a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > <a class="breadcrumb" href="javascript:void(0);" onclick="rebacke()">交接记录管理</a> >历史交接记录
			<button class="SSbtn blue back" onclick="rebacke()">返回</button></div>
		<div class="content">
			<ul class="tabbox">
				<li style="display:block">
					...
					<div class="stabox">
						<div class="row form" style="margin-top: 40px;">
							...
							<div class="col-3">
								<label>交班类型</label>
								<select  id="relievedtype">
									<option value="">全部</option>
									<option value="0">自主交班</option>
									<option value="1">人工指派</option>
								</select>
							</div>
						...
						<div class="row">
							<div class="col-12">
								<h4>历史交接信息【<%=request.getParameter("plateNo")%>】</h4>
							</div>
						</div>
		...
		<script type="text/javascript" src="js//driverShiftManage/driverShiftRecord/detail.js"></script>
	</body>
</html>
