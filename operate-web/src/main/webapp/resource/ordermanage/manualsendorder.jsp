		...
		<div class="crumbs">
            ...
            <c:choose>
                ...
                <c:when test="${ordertype == 2}">
                    <button class="SSbtn blue back" target="iframe" onclick="javascript:window.location.href='Order/jieji'">返回</button>
                </c:when>
                <c:when test="${ordertype == 3}">
                    <button class="SSbtn blue back" target="iframe" onclick="javascript:window.location.href='Order/songji'">返回</button>
                </c:when>
                <c:otherwise>
