...
<html lang="zh-CN">
	...
	<body class="ordermanage_css_body">
		...
		<div class="crumbs">
			<a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > <a class="breadcrumb" href="OrderManage/OrderIndex">网约车订单</a> > 订单复核
	            	...
	            	<form id="orderReivewForm" method="get">
		            	...
		            	<div class="row form">
		            		<div class="col-12">
			            		...
			            		<input id="mileage" name="mileage" style="width: 60%" oninput="getPrice()" type="text" maxlength="6" placeholder="服务里程">公里
		            		</div>
		            	</div>
		            	<div class="row form" id="counttimesDiv">
		            		<div class="col-12">
			            		<label>计费时长<em class="asterisk"></em></label>
			            		<input id="counttimes" oninput="getPrice()" name="counttimes" style="width: 60%" maxlength="6" type="text" placeholder="计费时长">分钟
		            		</div>
		            	</div>
		            	<div class="row form">
		            		<div class="col-12">
		...
		<script type="text/javascript" src="js/ordermanage/orderreview.js"></script>
	</body>
</html>
