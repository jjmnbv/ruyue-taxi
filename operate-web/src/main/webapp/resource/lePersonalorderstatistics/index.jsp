...
<html lang="zh-CN">
	...
	<!-- <body> -->
       ...
       .form select{width:68%;}
		...
		<h2 style="padding-top:30px"><img style="width:19px;height:19px;" src="img/index/icon_census.png">&nbsp;&nbsp;&nbsp;订单统计</h2>
		<div class="row">
					<div class="col-3">
					<label>时间</label>
          ...
          <h2><img style="width:19px;height:19px;" src="img/index/icon_month.png">&nbsp;&nbsp;&nbsp;按月度统计</h2>
           ...
           <div class="col-4" style="text-align: right;border-bottom: 1px solid #dbdbdb;padding-bottom:17px">
            <button class="Mbtn blue_q" onclick="exportOrganExcel2()">导出数据</button>
           </div>
          </div>
           <div class="row">
					<div class="col-3">
					...
					<div class="col-3">
					<label>客户名称</label>
					<select id="customer1" name="customer1"style="width: 200px;padding-top: 5px;padding-bottom: 5px;">
						<option value="" selected="selected">全部</option>
						<c:forEach var="customer" items="${customer}">
							<option value="${customer.id}">${customer.text}</option>
						</c:forEach>
				    ...
				    <div class="col-3">
					<label>入账状态</label>
					<select id="paymentstatus" name="paymentstatus"style="width: 132px;padding-top: 5px;padding-bottom: 5px;">
						<option value="" selected="selected">全部</option>
						<c:forEach var="paymentstatus" items="${paymentstatus}">
							<option value="${paymentstatus.value}">${paymentstatus.text}</option>
						</c:forEach>
					</select>
				    </div>
		</div>
		<div class="row">
		  <div class="col-12" style="text-align: right;">
           ...
           <div class="row">
			 ...
			 <div class="col-4" style="text-align: right;border-bottom: 1px solid #dbdbdb;padding-bottom:17px">
			 <button class="Mbtn blue_q" onclick="exportOrganExcel3()">导出数据 </button>
			 </div>
		   </div>
			 <div class="row">
					<div class="col-3">
					<label>时间</label>
	            		<input style="width:35%;" id="startTime2" name="startTime2" type="text" placeholder="开始日期" value="" class="searchDate"readonly="readonly">
					</div>
					<div class="col-3">
					<label>客户名称</label>
					<select id="customer2" name="customer2"style="width: 200px;padding-top: 5px;padding-bottom: 5px;">
						<option value="" selected="selected">全部</option>
						<c:forEach var="customer" items="${customer}">
							<option value="${customer.id}">${customer.text}</option>
						</c:forEach>
					...
					<select id="ordertype1" name="ordertype1"style="width: 132px;padding-top: 5px;padding-bottom: 5px;">
				     ...
				     <div class="col-3">
					<label>入账状态</label>
					<select id="paymentstatus1" name="paymentstatus1"style="width: 132px;padding-top: 5px;padding-bottom: 5px;">
						<option value="" selected="selected">全部</option>
						<c:forEach var="paymentstatus" items="${paymentstatus}">
							<option value="${paymentstatus.value}">${paymentstatus.text}</option>
						</c:forEach>
		...
		<div class="row">
				    <div class="col-3">
					<label>城市</label> 
					<input id=city name="city" type="hidden" placeholder="全部"style="width:50%;">
			       </div>
