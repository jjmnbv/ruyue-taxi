...
<div class="content">
		<ul class="tabmenu">
			...
			<li class="on"><a href="Order/songji">送机</a></li>
		</ul>
        <form id="form" class="form form_songji"  method="post">
	        <input type="hidden" name="ordertype" id="ordertype" value="3"/>
	        <div class="row">
                <div class="col-3">
                	<label class="songji-item">服务车企<em class="asterisk"></em></label>
		            <select id="company">
            ...
            <div class="row" id="user">
                <div class="col-3">
                	<label class="songji-item">下单人<em class="asterisk"></em></label>
                	<input type="hidden" value="" id="userid" name="userid" />
                </div>
                <div class="col-1"></div>
                <div class="col-3">
                	<label class="songji-item-passenger">乘车人<em class="asterisk"></em></label>
                	<input type="hidden" value="" id="passengers" name="passengers"/>
                </div>
                <div class="col-1 col-1-songji"><button class="Mbtn blue passengers" type="button" data-owner="passengers">常用</button></div>
            </div>
            <div class="row">
<!--                 <div class="col-3"> -->
<!--                 	<label>用车时间<em class="asterisk"></em></label><input type="text" placeholder="用车时间" name="usetime" id="usetime" class="xx" /> -->
<!--                 </div> -->
                <div class="col-3">
                	<label class="songji-item">用车时间<em class="asterisk"></em></label>
                ...
                <div class="col-1"></div>
                <div class="col-3">
                	<label class="songji-item-passenger">乘车人电话<em class="asterisk"></em></label>
                	<input type="hidden" value="" id="passengerphone" name="passengerphone" />
                </div>
                <div class="col-1 col-1-songji"><button class="Mbtn blue passengerphone" type="button" data-owner="passengerphone">常用</button></div>
            </div>
            <div class="row">
                <div class="col-3"><label  class="songji-item" style="width:31%;margin-left: -5px;">机场地址<em class="asterisk"></em></label>
					<input type="hidden" value="" id="offaddrlng" name="offaddrlng"/>
                	<input type="hidden" value="" id="offaddrlat" name="offaddrlat"/>
                	<input type="hidden" id="offCity" name="offcity" style="width:25%;"/>
					<select name="offaddress" id="offAddress"  style="width:42%;">
	              		<option value="0" data-owner="offCity">请选择</option>
                	</select>
                </div>
                <div class="col-1" ></div>
                <div class="col-6 validatecustomstyle" style="position:relative;">
									<label class="car-address" style="width:15.2%;margin-left: -5px;">上车地址<em class="asterisk"></em></label>
                	...
                	<input type="text" placeholder="可输入搜索" style="width:74%;" name="onaddress" id="onAddress" maxLength="200"/>
                	<!-- 前端补充  -->
			  		<div class="dizhibox" style="position:absolute;top:36px;left:27.2%;z-index:1000;border:1px solid #ededed;background:#fff;width:71%;">
				  		<div class="stab">
                ...
                <div class="col-1 col-1-songji" ><button class="Mbtn blue onMap" type="button">地图</button></div>
            </div>
            <div class="row">
                <div class="col-7">
                	<label class="travel-notes" style="width:12.5%;float:left;margin-left: -23px;">行程备注</label>
