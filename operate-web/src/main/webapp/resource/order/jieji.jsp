...
<div class="content">
        ...
        <form id="form" class="form form_jieji"  method="post">
	        <input type="hidden" name="ordertype" id="ordertype" value="2"/>
            <div class="row">
                <div class="col-3">
                	<label class="jieji-item">服务车企<em class="asterisk"></em></label>
		            <select id="company">
            ...
            <div class="row" id="user">
                <div class="col-3">
                	<label class="jieji-item">下单人<em class="asterisk"></em></label>
                	<input type="hidden" value="" id="userid" name="userid" />
                </div>
                <div class="col-1 col-1-none"></div>
                <div class="col-3">
                	<label class="jieji-item">乘车人<em class="asterisk"></em></label>
                	<input type="hidden" value="" id="passengers" name="passengers"/>
                </div>
                <div class="col-1 col-1-jieji"><button class="Mbtn blue passengers" type="button" data-owner="passengers">常用</button></div>
                <div class="col-3">
                	<label class="jieji-item-phone">乘车人电话<em class="asterisk"></em></label>
                	<input type="hidden" value="" id="passengerphone" name="passengerphone" />
                </div>
                <div class="col-1 col-1-jieji">
										<button class="Mbtn blue passengerphone" type="button" data-owner="passengerphone">常用</button>
								</div>
            </div>
            <div class="row row-float">
                <div class="col-3">
                	<label class="jieji-item">用车时间<em class="asterisk"></em></label>
	                <div class="ztimepicker">
						<input type="text" readonly value="" class="ztimepicker_input ztimepicker_width" name="usetime" id="usetime" style="width:100%;"/>
						<div class="ztimebox">
                ...
                <div class="col-1 col-1-none"></div>
				<div class="col-3"><label class="jieji-item">航班号<em class="asterisk"></em></label>
					<input type="text"  value="" name="fltno" id="fltno"	class="fltno"  style="width:68%;" maxlength="6"/>
				</div>
				<div class="col-1 col-1-none col-1-width"></div>
				<div class="col-3">
                	<label class="jieji-item-phone">降落时间<em class="asterisk"></em></label>
                     <div class="ztimepicker ztimepicker-landing">
						<input type="text" readonly value="" class="ztimepicker_input ztimepicker_width" name="falltime" id="falltime" style="width:100%;"/>
						<div class="ztimebox">
            ...
            <div class="row row-addr">
                <div class="col-3"><label class="jieji-item">机场地址<em class="asterisk"></em></label>
					...
					<select name="onaddress" id="onAddress" class="select-address" style="width:42%;">
	              		<option value="0">请选择</option>
                	</select>
            	</div>
            	<div class="col-1 col-1-none" ></div>
                <div class="col-7 validatecustomstyle" style="position:relative;">
								<label class="get-off" style="width:14%;margin-left: -13px;">下车地址<em class="asterisk"></em></label>
                	...
                	<!-- 前端补充  -->
			  		<div class="dizhibox" style="position:absolute;top:36px;left:25.3%;z-index:1000;border:1px solid #ededed;background:#fff;width:72%;">
				  		<div class="stab">
                ...
                <div class="col-1 col-1-jieji col-1-offMap" ><button class="Mbtn blue offMap" type="button">地图</button></div>
            </div>
            <div class="row row-remark">
                <div class="col-12">
                	<label  class="travel-notes" style="width:7%;float:left;margin-left: -19px;">行程备注</label>
                	<textarea rows="1" style="width:84%;margin-left: 25px;"  placeholder="填写行程备注" name="tripremark" id="tripremark" maxlength="250"></textarea>
				</div>
            </div>
