...
<div class="crumbs">
    <a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> >时间栅栏设置
    <a class="btn btn-primary  blue pull-right" id="btnInsert " style="margin-top: -6px;" href="<%=basePath%>SetTimeFence/toAddOrUpdate/0"><img src="img/trafficflux/icon/add.png" />新增</a>
...
<script type="text/javascript" src="js/setTimeFence/index.js"></script>
