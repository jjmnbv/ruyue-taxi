...
<div class="crumbs">
    ...
    <a href="<%=basePath%>SetTimeFence/Index">时间栅栏设置</a> >分配车辆
    <button type="button" id="btnCancel" class="btn blue btn-md pull-right"><i class="fa fa-reply" style="width:auto;"></i>返回</button>
    <button type="button" class="btn blue btn-md pull-right" id="btnBind" onclick="onBind()"><img src="img/trafficflux/icon/add.png" />添加车辆</button>
</div>
<!-- 头部 -->
<div class="content">
...
<script type="text/javascript" src="js/setTimeFence/timeFenceToVehc.js"></script>
