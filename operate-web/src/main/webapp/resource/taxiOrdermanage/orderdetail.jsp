...
<html lang="zh-CN">
	...
	<body  class="ordermanage_css_body">
		...
		<div class="crumbs">
			<a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > <a class="breadcrumb" href="TaxiOrderManage/Index">出租车订单</a> > 订单详情
	            ...
	            <div class="w400" style="width: 371px;">
	            	<form id="orderCommentForm" method="get">
		            	...
		            	<div class="row form" style="text-align: left;padding-left: 47px;">
		            		<textarea id="remark" name="remark" rows="2" style="width: 94%;height: 110px;" maxlength="100" cols="3" placeholder="请输入备注内容"></textarea>
		            	</div>
	            	</form>
		...
		<script type="text/javascript" src="js/taxiOrdermanage/orderdetail.js"></script>
	</body>
</html>
