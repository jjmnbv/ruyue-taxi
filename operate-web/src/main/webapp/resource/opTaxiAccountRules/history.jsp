...
<html lang="zh-CN">
	...
	<body>
		...
		<div class="crumbs">
			...
			<a href="OpTaxiAccountRules/Index" class="breadcrumb">出租车计费规则</a> >  历史规则
			<button class="SSbtn blue back" onclick="window.history.go(-1);" style="margin-top: -1px;">返回</button>
		</div>
		<div class="content">
			<input name="ruleid" id="ruleid" value="${id}" type="hidden">
			<div class="row" style="padding-top: 30px;">
			   <div class="col-12" style="margin-top: 15px;">
			   		<h4>历史规则记录【<span class="font_red">${cityname}</span>】</h4>
			   </div>
			</div>
		...
		<script type="text/javascript" src="js/opTaxiAccountRules/history.js"></script>
	</body>
</html>
