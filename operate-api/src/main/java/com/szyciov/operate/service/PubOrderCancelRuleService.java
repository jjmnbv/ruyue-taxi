...
import com.szyciov.operate.dao.PubOrderCancelRuleDao;
...
//		history.setOperationtype("");
	...
	public void insetRedis(String id,int type){
		...
		//拼接key
		String theKey = "ORDERCANCELRULE"+"_"+pubOrderCancelRule.getCitycode()+"_"+pubOrderCancelRule.getCartype()+"_"+pubOrderCancelRule.getPlatformtype()+"_"+pubOrderCancelRule.getId();
		if(type == 0){
