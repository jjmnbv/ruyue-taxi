...
function manticOrder(){
	...
	window.location.href=document.getElementsByTagName("base")[0].getAttribute("href") + 'OrderManage/ManualSendOrderIndex?orderno='+$("#orderno").val()+'&type=1&usetype='+usetype;
}
