...
function initOrder() {
	...
	$.get($("#baseUrl").val() + "OrderManage/GetOpTaxiOrderByOrderno?datetime=" + new Date().getTime(), data, function (result) {
		if (result) {
...
function initTraceData(order) {
	...
	$.get($("#baseUrl").val() + "OrderManage/GetOpTaxiOrderTraceData?datetime=" + new Date().getTime(), data, function (result) {
...
function artificialOrderRecord() {
	var data = {orderno: orderObj.orderno};
	$.get($("#baseUrl").val() + "OrderManage/GetOpSendTaxiOrderRecord?datetime=" + new Date().getTime(), data, function (result) {
		if (result) {
...
function changeDriverRecorddataGridInit() {
	var gridObj = {
        ...
        sAjaxSource: $("#baseUrl").val() + "OrderManage/GetOpChangeDriverList",
...
function changeVehicleRecorddataGridInit() {
	var gridObj = {
        ...
        sAjaxSource: $("#baseUrl").val() + "OrderManage/GetOpChangeVehicleList",
        userQueryParam: [{name: "orderNo", value: orderObj.orderno}],
        language: {
...
function reviewRecordDataGridInit() {
	var gridObj = {
        ...
        sAjaxSource: $("#baseUrl").val() + "OrderManage/GetOpTaxiOrderReviewByQuery",
        userQueryParam: [{name: "orderno", value: orderObj.orderno}],
        scrollX: true,
        iLeftColumn: 1,
        language: {
...
function ordercomment() {
	var gridObj = {
			id: "commentDataGrid",
	        sAjaxSource: $("#baseUrl").val() + "OrderManage/GetOpTaxiOrderCommentByQuery",
	        userQueryParam: [{name: "orderno", value: orderObj.orderno}],
	        iDisplayLength: 3,
	        language: {
