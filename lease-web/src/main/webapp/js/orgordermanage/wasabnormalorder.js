...
function manualOrderdataGrid() {
	var gridObj = {
        ...
        userQueryParam: [{name: "type", value: "4"}, { name: "usetype", value: "0" }],
        iLeftColumn: 3,
        scrollX: true,
        language: {
        ...
        columns: [
            ...
            {mDataProp: "actualpayamount", "sClass": "center", "sTitle": "实付金额(元)", sortable: true,
                "mRender": function(data, type, full) {
...
function exportOrder() {
	...
	window.location.href = $("#baseUrl").val()
			...
			+ orderType + "&organId=" + organId + "&reviewperson=" + reviewperson
