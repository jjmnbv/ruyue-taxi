...
function initGrid() {
	var gridObj = {
		id: "dataGrid",
        sAjaxSource: "PubDriverAccount/GetDetailedByQuery?driverid=" + $("#driverid").val()+"&detailed=transaction",
        iLeftColumn: 1,
        scrollX: true,
        language: {
...
function exportExcel() {
	...
	+$("#driverid").val()+"&queryTradetype="+$("#queryTradetypes").val()+"&startTime="+$("#startTimes").val()+"&endTime="+$("#endTimes").val()+"&detailed=transaction"
