...
function manualOrderdataGrid() {
	var gridObj = {
        ...
        userQueryParam: [{name: "type", value: "6"}, { name: "usetype", value: "1" }],
        iLeftColumn: 3,
        scrollX: true,
        language: {
        ...
        columns: [
            ...
            {mDataProp: "paymethod", sTitle: "支付方式", sClass: "center", sortable: true,"mRender": function(data, type, full) {
                    switch(full.paymethod) {
                        case "0": return "个人支付"; break;
                        case "1": return "个人垫付"; break;
                        default: return "/";
                   }
                }
            },
