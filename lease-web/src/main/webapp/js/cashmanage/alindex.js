	...
	var gridObj = {
        ...
        columns: [
            ...
            {mDataProp: "processresult", sTitle: "处理结果", sClass: "center", sortable: true,
            	 "mRender": function (data, type, full) {
                     switch(full.processresult) {
                     	case "0": return "已打款"; break;
                     	case "1": return "不予提现"; break;
                     	default: return "";
                     }
                  }
            },
            {mDataProp: "processreason", sTitle: "处理原因", sClass: "center", sortable: true,
            	"mRender": function (data, type, full) {
                    if(full.processreason) {
                    	return showToolTips(full.processreason,25);
                    }else{
                    	return "/";
                    }
                 }
            },
            {mDataProp: "processtime", sTitle: "处理时间", sClass: "center", sortable: true },
