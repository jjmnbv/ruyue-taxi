...
function initGrid() {
	var gridObj = {
		id: "dataGrid",
        sAjaxSource: "TmpOrderManage/GetNetAboutCarOrderByQuery",
        iLeftColumn: 3,
        scrollX: true,
        language: {
...
function initSelect2() {
	...
	$("#driver").select2({
		...
		allowClear : true,
		ajax : {
			url : "OrderManage/GetNetAboutCarOrderDriverByQuery?vehicleType=0",
			dataType : 'json',
			data : function(term, page) {
				return {
					driver: term
...
function exportExcel() {
	window.location.href= document.getElementsByTagName("base")[0].getAttribute("href") + "OrderManage/GetNetAboutCarOrderExport?orderNo="+$("#orderNoExport").val()
