...
<body>
	<div class="crumbs">
		<a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > <a href="PubDriver/Index" class="breadcrumb">司机管理 </a> > 司机详情
		...
		<form id="editDriverForm" class="form" method="post">
			<div class="row">
				<div class="col-4">
					...
					<input type="text" placeholder="司机资格证号" name="jobNum" id="jobNum" value="${pubDriver.jobNum}" disabled="disabled">
				</div>
			...
			<div class="row">
				...
				<div class="col-4">
					<label>归属车企<em class="asterisk"></em></label> <select id="belongleasecompany" name="belongleasecompany" disabled="disabled">
							<option value="${pubDriver.belongleasecompany}">${pubDriver.belongleasecompanyName}</option>
					</select>
				</div>
			</div>
			<div class="row">
					   ...
					   <c:when test="${pubDriver.idEntityType != null && pubDriver.idEntityType != ''}">  
			               <c:choose>
			               		<c:when test="${pubDriver.idEntityType == '1'}">
			               			<input id="idEntityTypeP" name="idEntityType" type="radio" value="0" disabled="disabled"/>普通司机 
						   			<input id="idEntityTypeT" name="idEntityType" type="radio" value="1" checked="checked" disabled="disabled"/>特殊司机
			               		</c:when>
			               		<c:otherwise> 
			               			<input id="idEntityTypeP" name="idEntityType" type="radio" value="0" checked="checked" disabled="disabled"/>普通司机 
						   			<input id="idEntityTypeT" name="idEntityType" type="radio" value="1" disabled="disabled"/>特殊司机
					   			</c:otherwise>
			               </c:choose>     
					   </c:when>
					   <c:otherwise> 
				...
				<div class="col-4" id="serviceOrg" style="display: none;">
					...
					<textarea cols="50" rows="3" id="serviceOrgName" name="serviceOrgName" placeholder="" value="" disabled="disabled" style="width: 280px;">${pubDriver.serviceOrgName}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-12">
