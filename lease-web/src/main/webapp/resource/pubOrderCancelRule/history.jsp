...
<html lang="zh-CN">
	...
	<body>
		<div class="crumbs"><a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > <a class="breadcrumb" href="PubOrderCancelRule/Index">订单取消规则</a> >历史记录
		</div>
		<div class="content">
		<input id="aaid" name="aaid" value="${aaid}"type="hidden"/>
		<div class="row">
				<div class="col-4" style="margin-top: 15px;">
					<h4>历史记录信息<span id="">【${pubOrderCancelRule.cartype}】</span></h4>
				</div>
			</div>
			<table id="dataGrid" class="table table-striped table-bordered" cellspacing="0" width="100%"></table>
		</div>
		<script type="text/javascript" src="js/pubOrderCancelRule/history.js"></script>
