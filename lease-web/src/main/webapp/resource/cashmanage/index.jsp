...
<html lang="zh-CN">
	...
	<body class="ordermanage_css_body">
		...
		<div class="content">
			<ul class="tabbox">
				<li style="display:block">
					<div class="stab">
						<div class="shen_on">待处理提现</div>
						<div><a href="LeCashManage/AlIndex" style="text-decoration: none;">已处理提现</a></div>
					</div>
					<div class="stabox">
						<div class="row form" style="margin-top: 40px;">
							...
							<div class="col-3">
								<label>账号名称</label><input id="creditcardname" type="hidden" placeholder="账号名称">
							</div>
							...
							<div class="col-12" style="text-align: right;">
								<button class="Mbtn red" onclick="search();">查询</button>
						...
						<div class="row">
							<div class="col-12" style="position:relative;margin-top:15px;">
								<h4>提现申请信息</h4>
								<button class="Mbtn blue_q" style="position:absolute;right:5px;top:-5px;" onclick="exportData();">导出数据</button>
							</div>
						</div>
			...
			<div class="tip_box_b">
	            ...
	            <div class="w400">
	            	...
	            	<form id="cancelpartyForm" method="get" class="form">
		            	...
		            	<div class="row">
			                <textarea maxlength="200" id="reasonTextarea" name="reasonTextarea" style="width:70%;float:left;margin-left:20px;" rows="2" cols="3" placeholder="填写不予提现的原因（必填）"></textarea>
			            </div>
	            	</form>
		...
		<script type="text/javascript" src="js/cashmanage/index.js"></script>
	</body>
</html>
