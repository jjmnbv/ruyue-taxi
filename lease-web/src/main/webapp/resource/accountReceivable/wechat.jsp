...
<body>
	<div class="crumbs">
		<a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > <a class="breadcrumb" href="AccountReceivable/Index">乘客收款账户管理</a> > 微信收款账户
	</div>
	<div class="content">
		...
		<form id="editWechatForm" class="form" method="post">
			...
			<div class="row">
				<div class="col-6">
					...
					<textarea rows="2" cols="5" style="width: 70%;" id="wechatAccount" name="wechatAccount"  maxlength="50">${leLeasescompany.wechatAccount}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					<label>APPID<em class="asterisk"></em></label>
					<textarea rows="3" cols="5" style="width: 70%;" id="wechatappid" name="wechatappid"   maxlength="100">${leLeasescompany.wechatappid}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					<label>商户号<em class="asterisk"></em></label>
					<%-- <input type="text" id="wechatmerchantno" name="wechatmerchantno" value="${leLeasescompany.wechatmerchantno}"  maxlength="100"> --%>
					<textarea rows="3" cols="4" style="width: 70%;" id="wechatmerchantno" name="wechatmerchantno"  maxlength="100">${leLeasescompany.wechatmerchantno}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					<label>商户密钥<em class="asterisk"></em></label>
					<%-- <input type="text" id="wechatsecretkey" name="wechatsecretkey" value="${leLeasescompany.wechatsecretkey}"  maxlength="100"> --%>
					<textarea rows="3" cols="5" style="width: 70%;" id="wechatsecretkey" name="wechatsecretkey"  maxlength="3500">${leLeasescompany.wechatsecretkey}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
	...
	<script type="text/javascript" src="js/accountReceivable/wechat.js"></script>
	<script type="text/javascript">
