...
<body>
	<div class="crumbs">
		<a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > <a class="breadcrumb" href="AccountReceivable/Index">乘客收款账户管理</a> > 支付宝收款账户
	</div>
	<div class="content">
		...
		<form id="editAlipayForm" class="form" method="post">
			...
			<div class="row">
				<div class="col-6">
					...
					<textarea rows="2" cols="4" style="width: 70%;" id="alipayAccount" name="alipayAccount"  maxlength="50">${leLeasescompany.alipayAccount}</textarea>
				</div>
			</div>
			<div class="row">	
				<div class="col-6">
					<label>APPID<em class="asterisk"></em></label>
					<textarea rows="3" cols="4" style="width: 70%;" id="alipayappid" name="alipayappid"  maxlength="100">${leLeasescompany.alipayappid}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					<label>应用私钥<em class="asterisk"></em></label>
					<%-- <input type="text" id="alipayprivatekey" name="alipayprivatekey" value="${leLeasescompany.alipayprivatekey}"  maxlength="100"> --%>
					<textarea rows="28" cols="4" style="width: 70%;" id="alipayprivatekey" name="alipayprivatekey"  maxlength="3500">${leLeasescompany.alipayprivatekey}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					...
					<textarea rows="9" cols="5" style="width: 70%;" id="alipaypublickey" name="alipaypublickey"  maxlength="3500">${leLeasescompany.alipaypublickey}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					<label>合作伙伴ID<em class="asterisk"></em></label>
					<textarea rows="3" cols="4" style="width: 70%;" id="alipaypartnerid" name="alipaypartnerid"  maxlength="100">${leLeasescompany.alipaypartnerid}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					...
					<%-- <input type="text" id="alipayprivatekey" name="alipayprivatekey" value="${leLeasescompany.alipayprivatekey}"  maxlength="100"> --%>
					<textarea rows="28" cols="4" style="width: 70%;" id="alipaypartnerprivatekey" name="alipaypartnerprivatekey"  maxlength="3500">${leLeasescompany.alipaypartnerprivatekey}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
					...
					<%-- <input type="text" id="alipaypublickey" name="alipaypublickey" value="${leLeasescompany.alipaypublickey}"  maxlength="100"> --%>
					<textarea rows="6" cols="5" style="width: 70%;" id="alipaypartnerpublickey" name="alipaypartnerpublickey"  maxlength="3500">${leLeasescompany.alipaypartnerpublickey}</textarea>
				</div>
			</div>
			<div class="row">
				<div class="col-6">
	...
	<script type="text/javascript" src="js/accountReceivable/alipay.js"></script>
	<script type="text/javascript">
