		...
		<input name="organId" id="organId" value="${organId}" type="hidden">
			...
			<div class="row">
				<div class="col-3"style="text-align: center;">
					<label>司机</label>
					<input id="keyword" name="keyword" type="text" placeholder="司机名称/手机号码">
				</div>
					<div class="col-3" style="text-align: center;">
					<label>服务起止时间</label>
					...
					<div class="col-3"style="text-align: center;">
                    <label>车牌</label>
				   <input id="plateno" name="plateno" type="text" placeholder="车牌">
				</div>
				<div class="col-3"style="text-align: center;">
					<label >品牌车系</label>
			...
			<div class="col-3"style="text-align: center;">
                    <label>资格证号</label>
				   <input id="jobnum" name="jobnum" type="text" placeholder="司机资格证号">
				</div>
			...
			<div class="row1">
            	...
            	<div class="col1-4 lepersonal_css_col_1">
	                <div class="radius row1">
		                <div class="order_tittle col1-6" style="border-right:1px solid #ddd;border-bottom:0px solid #ddd"><img margin-bottom:0px;" src="img/index/icon_jigou.png">
		                	<span style="vertical-align:text-bottom;margin-left:5px;font-size:20px;"id="">服务机构</span></div>
		               <div class="order_tittle col1-6"style="border-bottom:0px solid #ddd"><img margin-bottom:0px;" src="img/index/icon_person.png">
		                	<span style="vertical-align:text-bottom;margin-left:5px;font-size:20px"id="">服务个人</span></div>
		                <div class="col1-6" style="border-right:1px solid #ddd;">
		                  <span id="sumOragnAgency"style="font-weight:bold;font-size:18px"></span><br>
		                </div>
		                 <div class="col1-6">
		                 <span id="sumPersonOrders"style="font-weight:bold;font-size:18px"></span><br>
		                </div>
	                </div>
            	</div>
            	<!-- <div class="col1-4">
	                <div class="radius row1">
		                <div class="col1-6" style="border-right:1px solid #ddd;line-height:400%;font-weight:bold;">
		                	<strong id=""></strong>
		                	<img src="img/index/icon_jigou.png">&nbsp;&nbsp;服务机构
		                </div>
		                <div class="col1-6" style="line-height:400%;font-weight:bold;">
		                	<strong id=""></strong>
		                	<img src="img/index/icon_person.png">&nbsp;&nbsp;服务个人
		                </div>
		                 <div class="col1-6"style="border-right:1px solid #ddd;font-weight:bold">
		                	<strong id="sumOragnAgency"></strong>
		                </div>
		                 <div class="col1-6">
		                	<strong id="sumPersonOrders"></strong>
		                </div>
	                </div>
            	</div> -->
            </div>
            <div class="row">
           <div class="col-8"><h2><img style="width:19px;height:19px;" src="img/index/icon_jigou.png">&nbsp;&nbsp;&nbsp;toB订单统计</h2></div>
           <div class="col-4" style="text-align: right;border-bottom: 1px solid #dbdbdb;padding-bottom:17px">
           <button class="Mbtn blue_q" onclick="exporttoBExcel()">导出数据
           </button>
           </div>
           <table id="dataGridtoB" class="table table-striped table-bordered" cellspacing="0" width="100%"></table>
           </div>
           <div class="row">
           <div class="col-8"><h2><img style="width:19px;height:19px;" src="img/index/icon_person.png">&nbsp;&nbsp;&nbsp;toC订单统计</h2></div>
           <div class="col-4" style="text-align: right;border-bottom: 1px solid #dbdbdb;padding-bottom:17px">
