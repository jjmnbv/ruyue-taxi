...
<div class="crumbs">
    <a href="javascript:void(0);" onclick="homeHref()" class="breadcrumb">首页</a> > <a class="breadcrumb" href="PubCoooperateUnion/Index" onclick="back()">合作运营管理</a> > 合作协议
...
<script>
    function back(){window.location.href="PubCoooperateUnion/Index"}
</script>
</body>
</html>
