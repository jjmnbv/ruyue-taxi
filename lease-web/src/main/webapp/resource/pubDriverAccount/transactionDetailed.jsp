...
<html lang="zh-CN">
	...
	<body>
		<div class="crumbs">
			<a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > <a class="breadcrumb" href="PubDriverAccount/Index"> 司机账户</a> > 交易明细
		...
		<div class="content">
			...
			<div class="row">
			   <div class="col-10" style="margin-top: 15px;width:60%;"><h4>交易明细【<span class="font_red">${driverName} ${driverAccount}</span>】</h4></div>
		...
		<script type="text/javascript" src="js/pubDriverAccount/transactionDetailed.js"></script>
	</body>
</html>
