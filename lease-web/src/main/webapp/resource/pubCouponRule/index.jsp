...
<html lang="zh-CN">
	...
	<style type="text/css">
		...
		.marginvisual2{margin-left: 8px;display: inline-block;margin-top:4px;}
	...
	<body>
		...
		<div class="content">
			<div class="row form" style="padding-top: 30px;">
				...
				<div class="col-4">
					<label>规则对象</label>
					<select id="ruletargetQuery" name="ruletargetQuery">
						<option value="" selected="selected">全部</option>
	            ...
	            <div style="max-height:448px;overflow-y:scroll;overflow-x:hidden;padding-bottom: 40px;">
	            	<form id="createForm">
	                    ...
	                    <div class="row">
	                        <div class="col-12">
			                    ...
			                    <div class="col-6">
			                        ...
			                        <select id="ruletype" name="ruletype" style="width: 60%;" onchange="changeRuleType()">
							            <option value="" selected="selected">请选择派发类别</option>
							            <option value="1">注册返券</option>
							            <option value="2">充值返券</option>
							            <option value="3">消费返券</option>
							            <option value="4">活动返券</option>
		                    ...
		                    <div class="col-12">
			                    <div class="col-6" id="ruletarget1Div">
			                        <label>规则对象<em class="asterisk"></em></label>
			                        <input id="ruletarget1" name="ruletarget" type="radio" style="margin-left:0px;" value="2" checked/>机构用户&nbsp;&nbsp;<input id="ruletarget2" name="ruletarget" type="radio" value="1"/>机构客户
			                    </div>
			                    <div class="col-6" id="ruletarget2Div" style="display: none;">
			                        <label>规则对象<em class="asterisk"></em></label>
			                        <span>机构用户</span>
			                    </div>
		                ...
		                <div class="row" id="expenseDiv" style="display: none;">
		                    ...
		                    <div class="row" id="frenquencyDiv" style="display: none;">
			                    ...
			                    <div class="col-12">
		                            ...
		                            <div style="float:left;">
		                                 <span class="marginvisual2" style="margin-right: 8px;">次低于</span> 
		                            </div>
		                            <div style="float:left;width: 15%">
		                    ...
		                    <div class="row" id="monetaryDiv" style="display: none;">
			                    ...
			                    <div class="col-12">
		                            ...
		                            <div style="float:left;">
		                                 <span class="marginvisual2" style="margin-right: 8px;">元低于</span> 
		                            </div>
		                            <div style="float:left;width: 15%">
