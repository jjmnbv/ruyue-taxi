...
<html lang="zh-CN">
	...
	<body>
		<div class="crumbs">
		    <a class="breadcrumb" href="javascript:void(0);" onclick="homeHref()">首页</a> > <a class="breadcrumb" href="OrganUserAccount/Index">个人账户</a> > 交易明细
		...
		<div class="content">
			...
			<div class="row">
			   <div class="col-10" style="margin-top: 15px;width:60%;"><h4>交易明细【<span class="font_red">${account}</span>】</h4></div>
		...
		<script type="text/javascript" src="js/organUserAccount/accountDetail.js"></script>
	</body>
</html>
