...
<div class="content">
        ...
        <form id="form" class="form form-songji"  method="post">
        	<div class="row">
...
<!--                 </div> -->
            ...
            <div class="row">
                <div class="col-3"><label style="width:32%;margin-left: -4px;"class="airport-address">机场地址<em class="asterisk"></em></label>
					...
					<select name="offaddress" id="offAddress"  style="width:41%;">
	              		<option value="0" data-owner="offCity">请选择</option>
                	</select>
                </div>
                <div class="col-1 col-1-none"></div>
                <div class="col-7 col-7-remark">
                	<label style="width:13%;float:left;margin-left: -23px;" class="remark">行程备注</label>
                	<textarea rows="1" style="width:87%;margin-left: 22px;"  placeholder="填写行程备注" name="tripremark"  id="tripremark" maxlength="250"></textarea>
				</div>
				<div class="col-1" ></div>
            </div>
            <div class="row">
...
<!-- 							<option value="">---------------------------</option> -->
                ...
                <div class="col-7 vehiclessubjectstyle col-7-origin" id="vehiclessubjectDiv">
                	<label style="width:14%;float:left;margin-left: -14px;" class="explain">用车事由说明<em class="asterisk"></em></label>
