	...
	<body class="ordermanage_css_body">
		...
		<div class="content">
			<ul class="tabmenu" style="padding-top: 30px;">
				...
				<li><a href="TmpOrderManage/PersonWaitgatheringOrderIndex" style="text-decoration: none;">待收款订单</a></li>
			...
			<div class="row form" style="margin: 20px 0px;">
				...
				<div class="col-6 ordermanage_css_col_1">
					<label style="width: 15%;margin-left: -7px">用车时间</label>
					<input style="width:22%;min-width: 140px" id="minUseTime" name="minUseTime" type="text" readonly="readonly" placeholder="开始日期" value="" class="searchDate">
					至
            		<input style="width:22%;min-width: 140px" id="maxUseTime" name="maxUseTime" type="text" readonly="readonly" placeholder="结束日期" value="" class="searchDate">
				</div>
			...
			<div class="row" style="position:relative;">
				<div class="col-6">
					<h4 style="position:relative;">当前订单信息</h4>
				</div>
			</div>
			<table id="manualOrderdataGrid" class="table table-striped table-bordered" cellspacing="0" width="100%"></table>
		</div>
		
		<script type="text/javascript" src="js/tmppersonordermanage/currentorder.js"></script>
	</body>
</html>
