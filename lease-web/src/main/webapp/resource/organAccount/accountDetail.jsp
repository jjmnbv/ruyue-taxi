...
<html lang="zh-CN">
	...
	<body>
		...
		<div class="content">
			...
			<div class="row form" style="padding-top: 30px;">
				<div class="col-4">
					...
					<select id="type" name="type">
						...
						<option value="0">机构充值</option>
						<option value="1">机构提现</option>
			...
			<div class="row">
			   <div class="col-10" style="margin-top: 15px;width:60%;"><h4>账户往来明细【<span class="font_red">${fullName}</span>】</h4></div>
		...
		<script type="text/javascript" src="js/organAccount/accountDetail.js"></script>
	</body>
</html>
