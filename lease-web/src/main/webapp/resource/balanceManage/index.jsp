	...
	<body class="opuseraccount_css_body">
		...
		<div class="content">
			...
			<div class="row form" style="padding-top: 30px;">
				...
				<div class="col-3">
					<label>车牌号</label><input id="fullplateno" name="fullplateno" type="text" placeholder="车牌号">
				</div>
				...
				<div class="col-3">
					...
					<select id="companyid" name="companyid" style="width: 66%;margin-left:-4px;">
						...
						<c:forEach var="companyList" items="${companyList}">
							<option value="${companyList.id}">${companyList.text}</option>
						</c:forEach>
					</select>
				</div>
		...
		<script type="text/javascript" src="js/balanceManage/index.js"></script>
	</body>
</html>
