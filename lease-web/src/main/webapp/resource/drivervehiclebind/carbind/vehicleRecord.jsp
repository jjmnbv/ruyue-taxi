...
<html lang="zh-CN">
	...
	<body class="ordermanage_css_body">
		...
		<div class="content">
			<ul class="tabbox">
				<li style="display:block">
					<div class="stab">
						<div><a href="driverVehicleRecord/car/driverRecord" style="text-decoration: none;">司机操作记录</a></div>
						<div class="shen_on">车辆操作记录</div>
					</div>
					<div class="stabox">
						<div class="row form" style="margin-top: 40px;">
							...
							<div class="col-3">
								<label>车架号</label>
								<input id="vehicleId" type="hidden" placeholder="车架号">
							</div>
							<div class="col-3">
								<label>操作类型</label>
		...
		<script type="text/javascript" src="js/drivervehiclebind/carbind/vehicleRecord.js"></script>
	</body>
</html>
